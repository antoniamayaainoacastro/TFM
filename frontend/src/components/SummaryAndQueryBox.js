...
const SummaryAndQueryBox = ({ latestVideo }) => {
    ...
    const handleQuery = async () => {
        ...
        try {
            const response = await axios.post("https://backend-service-320582554125.europe-west4.run.app/api/query", {
                question: queryInput,
            });
    ...
    const handleQueryFeedback = async (result) => {
        ...
        try {
            await axios.post("https://backend-service-320582554125.europe-west4.run.app/api/feedback", feedbackData);
